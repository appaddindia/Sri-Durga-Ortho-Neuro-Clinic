    ...
    <>
      ...
      >
        ...
        <div className="tpsideinfo__content mb-60">
          ...
          Sri Durga Ortho & Neuro Clinic offers expert orthopedic and neurological care. Led by Dr. Shashikanth Vokkaleri and Dr. Surbhi Chaturvedi, we provide advanced treatments. Book your appointment today!
          </p>
          <span>Contact Us</span>
          <a style={{display:"flex"}} href="#">
            <i style={{marginTop:"4px"}} className="fa-solid fa-star"></i>1st Floor, Shiva Ram Karanath Nagar, No. 42 & 25, 80 Feet Rd, MCEHS Layout, Rachenahalli,Hegde Nagar , Bengaluru, Karnataka 560077
          </a>
          <a style={{display:"flex"}} href="tel:9980445660">
            <i style={{marginTop:"4px"}} className="fa-solid fa-star"></i>9980445660
          </a>
          <a style={{display:"flex"}} href="mailto:sridurgaorthoneuroclinic@gmail.com">
            <i style={{marginTop:"4px"}} className="fa-solid fa-star"></i>sridurgaorthoneuroclinic@gmail.com
          </a>
        </div>
